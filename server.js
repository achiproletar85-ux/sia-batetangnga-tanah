...
async function buildDocValues(record, extraValues) {
  ...
  const alias = {
    ...
    nama_pihak_pertama: dr.penjual_nama || dr.pemberi_nama || dr.pihak1_nama || '',
    nama_pihak_1: dr.penjual_nama || dr.pemberi_nama || dr.pihak1_nama || '',
    umur_pihak_pertama: dr.penjual_umur || dr.pemberi_umur || ageFrom(dr.penjual_tanggal_lahir) || '',
    umur_pihak_1: dr.penjual_umur || dr.pemberi_umur || ageFrom(dr.penjual_tanggal_lahir) || '',
    pekerjaan_pihak_pertama: dr.penjual_pekerjaan || dr.pemberi_pekerjaan || dr.pekerjaan_pihak1 || '',
    alamat_pihak_pertama: dr.penjual_alamat || dr.pemberi_alamat || dr.alamat_pihak1 || '',
    ...
    umur_pihak_kedua: dr.pembeli_umur || dr.penerima_umur || dr.pemohon_umur || ageFrom(dr.pembeli_tanggal_lahir || dr.tanggal_lahir) || '',
    umur_pihak_2: dr.pembeli_umur || dr.penerima_umur || dr.pemohon_umur || ageFrom(dr.pembeli_tanggal_lahir || dr.tanggal_lahir) || '',
    pekerjaan_pihak_kedua: dr.pembeli_pekerjaan || dr.penerima_pekerjaan || dr.pekerjaan || '',
