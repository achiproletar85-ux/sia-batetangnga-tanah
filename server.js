...
async function buildDocValues(record, extraValues) {
  ...
  const alias = {
    ...
    penjual_nama: dr.penjual_nama || dr.pemberi_nama || dr.pihak1_nama || dr.nama_penjual || '',
    umur_pihak_pertama: dr.penjual_umur || dr.pemberi_umur || ageFrom(dr.penjual_tanggal_lahir || dr.pemberi_tanggal_lahir) || '',
    umur_pihak_1: dr.penjual_umur || dr.pemberi_umur || ageFrom(dr.penjual_tanggal_lahir || dr.pemberi_tanggal_lahir) || '',
    penjual_umur: dr.penjual_umur || dr.pemberi_umur || ageFrom(dr.penjual_tanggal_lahir || dr.pemberi_tanggal_lahir) || '',
    umur_penjual: dr.penjual_umur || dr.pemberi_umur || ageFrom(dr.penjual_tanggal_lahir || dr.pemberi_tanggal_lahir) || '',
    pekerjaan: dr.penjual_pekerjaan || dr.pemberi_pekerjaan || dr.pekerjaan || '',
    pekerjaan_penjual: dr.penjual_pekerjaan || dr.pemberi_pekerjaan || dr.pekerjaan || '',
    ...
    alamat_penjual: dr.penjual_alamat || dr.pemberi_alamat || dr.alamat || '',
    ...
    pembeli_nama: dr.pembeli_nama || dr.penerima_nama || dr.pihak2_nama || record.nama,
    umur_pihak_kedua: dr.pembeli_umur || dr.penerima_umur || ageFrom(dr.pembeli_tanggal_lahir || dr.penerima_tanggal_lahir || dr.tanggal_lahir) || '',
    umur_pihak_2: dr.pembeli_umur || dr.penerima_umur || ageFrom(dr.pembeli_tanggal_lahir || dr.penerima_tanggal_lahir || dr.tanggal_lahir) || '',
    pembeli_umur: dr.pembeli_umur || dr.penerima_umur || ageFrom(dr.pembeli_tanggal_lahir || dr.penerima_tanggal_lahir || dr.tanggal_lahir) || '',
    umur_pembeli: dr.pembeli_umur || dr.penerima_umur || ageFrom(dr.pembeli_tanggal_lahir || dr.penerima_tanggal_lahir || dr.tanggal_lahir) || '',
    pekerjaan_pihak_kedua: dr.pembeli_pekerjaan || dr.penerima_pekerjaan || '',
    pekerjaan_pembeli: dr.pembeli_pekerjaan || dr.penerima_pekerjaan || '',
    alamat_pihak_kedua: dr.pembeli_alamat || dr.penerima_alamat || dr.alamat || '',
    alamat_pembeli: dr.pembeli_alamat || dr.penerima_alamat || dr.alamat || '',
...
app.get('/api/health', (req, res) => {
  res.json({
    success: true,
    version: '2026-08-22_02:53_dotted_leader',
